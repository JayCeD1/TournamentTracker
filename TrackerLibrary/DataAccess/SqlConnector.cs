    ...
    public class SqlConnector : IDataConnection
    {
        ...
        public void UpdateMatchup(MatchupModel model)
        {
            using (IDbConnection connection = new System.Data.SqlClient.SqlConnection(GlobalConfig.CnnString(db)))
            {
                ...
                {
                    if (me.TeamCompeting != null) //if team competing is null, it shudn't have a score either cuz it dain't have them
                    {
                        p = new DynamicParameters();
                        p.Add("@id", me.Id);
        ...
        {
            //[spTournamentComplete]
            using (IDbConnection connection = new System.Data.SqlClient.SqlConnection(GlobalConfig.CnnString(db)))
            {
                var p = new DynamicParameters();
                p.Add("@id", model.Id);
                connection.Execute("dbo.spTournamentComplete", p, commandType: CommandType.StoredProcedure);
            }
        }
    }
}
